...
This constraint makes the policy to update within a small region, utilizing more information from collected trajectories.

TRPO solves this constrained optimization problem, by using a linear quadratic programming.
